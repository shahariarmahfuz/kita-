...
.then(response => {
    ...
    return api.sendMessage("তোগো ভাবী লাগি সালাম দিয়া কথা কো 😾😾!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
কো তোগো কেমনে সাহায্য করমু!!! 
...
DEVELOPER : SHAHARIAR MAHFUZ 

🟣Facebook Account Link: 

https://www.facebook.com/itachiuchiha0102

🔵WHATSAPP NUMBER: wa.me/+8801893741716

🟢SUPPORT EMAIL: www.shahariarmajfuz2@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
